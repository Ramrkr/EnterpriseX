...
//   const {payments} = useAppData();
  ...
  //     // );
  //     case "manage-inventory": return <ManageInventoryScreen onBack={() => go("business-select")} onAdd={() => go("add-product")} onRestock={() => go("restock-goods")} onView={() => go("view-inventory")} />;
  //     case "add-product": return <AddProductScreen onBack={() => go("manage-inventory")}  />;
  //     case "restock-goods": return <RestockGoodsScreen onBack={() => go("manage-inventory")} />;
  ...
  //         onEdit={c => { setEditingCustomer(c); go("edit-customer"); }} />
  //     );
  //     case "add-customer": return <AddEditCustomerScreen onBack={() => go("manage-customers")} />;
  //     case "edit-customer": return <AddEditCustomerScreen customer={editingCustomer || undefined} onBack={() => go("manage-customers")}/>;
  //     case "view-customer": return <ViewCustomerScreen customer={selectedCustomer!} onBack={() => go("manage-customers")} />;
  //     case "home": return (
  ...
  //     // 14-07-2026 1:00 AM - REVIEWED UPTO THIS -----

  //     case "profile-dashboard": return <ProfileDashboardScreen onBack={() => go("home")} />;
  //     case "sales-report": return <SalesReportScreen onBack={() => go("home")} />;
  //     case "transactions": return <TransactionsScreen mode={mode} traderId={traderId} onBack={() => go("home")} />;
  //     case "orders-list": return (
  //       <OrdersListScreen mode={mode} traderId={traderId} onBack={() => go("home")}
  //         onAdd={() => { setCart([]); go("add-order"); }}
  //         onView={o => { setViewingOrder(o); go("view-order"); }}
  //         onEdit={o => { setEditingOrder(o); go("edit-order"); }}/>
  ...
  //     );
  //     case "view-order": return viewingOrder ? <ViewOrderScreen order={viewingOrder} payment={payments[viewingOrder.id]} onBack={() => go("orders-list")} /> : null;
  //     case "edit-order": return editingOrder ? <EditOrderScreen order={editingOrder} mode={mode} traderId={traderId} onBack={() => go("orders-list")} onSave={saveEditedOrder} /> : null;
  //     case "add-order": return <AddOrderScreen cart={cart} mode={mode} traderId={traderId} onBack={() => go("orders-list")} onUpdateCart={setCart} onViewCart={cid => { setCartCustomerId(cid); go("cart"); }} />;
  //     case "cart": return <CartScreen cart={cart} customerId={cartCustomerId} mode={mode} traderId={traderId} onBack={() => go("add-order")} onPlaceOrder={()=>{go("order-confirm");}} />;
  //     case "order-confirm": return currentOrder ? <OrderConfirmScreen order={currentOrder} onHome={() => go("home")} /> : null;
  //     default: return null;
  //   }
  // })();
